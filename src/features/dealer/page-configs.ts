...
export const pageConfigs = {
  models: {
    ...
    fields: [
      ...
      { key: "originalInputPrice", label: "输入原价（¥/1M Tokens）", kind: "number" },
      { key: "originalOutputPrice", label: "输出原价（¥/1M Tokens）", kind: "number" },
      { key: "originalCachePrice", label: "缓存原价（¥/1M Tokens）", kind: "number" },
      ...
      { key: "costCachePrice", label: "成本缓存价（¥/1M Tokens）", kind: "number" },
